...
const NavBar = () => {
  return (
    <div className="w-full lg:h-[48px] mx-[13px] flex justify-center items-center lg:mt-[60px] lg:gap-[40px] x-sm:h-[24px] x-sm:mt-[54px] x-sm:justify-between x-sm:mx-[16px] sm:h-[34px]">
