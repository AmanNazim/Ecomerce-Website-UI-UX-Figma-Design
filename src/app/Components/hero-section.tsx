  ...
  return (
    <div>
      <div className="relative w-full lg:h-full lg:mt-[24px] x-sm:bg-[#F2F0F1] x-sm:h-[878px] x-sm:mt-[20px] sm:h-full">
        ...
        <div className="absolute lg:w-[550px] h-[33px] lg:top-[104px] left-[13px] x-sm:w-[358px] x-sm:h-[50px] x-sm:mt-[153px] sm:w-[400px] sm:top-[10px]">
        ...
        <div className="absolute lg:w-[104px] lg:h-[104px] lg:top-[70px] lg:left-[1100px] x-sm:left-[320px] x-sm:top-[465px] x-sm:w-[74px] x-sm:h-[74px] sm:w-[80px] sm:h-[80px] sm:top-[30px] sm:left-[690px]">
          <Image
            className="h-full w-full"
