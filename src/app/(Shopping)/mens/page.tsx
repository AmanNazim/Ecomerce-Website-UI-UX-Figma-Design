...
const shopItemsDeskCasual = [
  {
    imgurl: "/images/one-line-graphic-t-shirt(4).svg",
    imgw: 296,
    imgh: 444,
    imgalt: "one life graphic t-shirt",
    imgtxt: "One Life Graphic T-Shirt",
    ...
    imgdelprice: "$300",
    imgdecdis: "-40%",
    productdetailpagelink: "/shop-men-t-shirts/",
  },
  {
    ...
    <div>
      ...
      <div className="w-full flex lg:mt-[24px] lg:mx-[13px] x-sm:mt-[12px] x-sm:justify-center  x-sm:mx-[16px]">
        ...
        <div className=" w-full lg:ml-[20px]">
          ...
          <div className="w-full mob-tab mt-[29px] -ml-[16px]">
