...
export default function Home() {
  ...
  const CusRevs = [
    {
      CusName: "Sarah M.",
      CusRev: "I'm blown away by the quality and style of the clothes I received from Shop.co. From casual wear to elegant dresses, every piece I've bought has exceeded my expectations.",
      MainDivW: "400px",
      MainDivH: "240px",
      RevDivW: "336px",
      RevDivH: "161px",
    ...
    {
      CusName: "Alex K.",
      CusRev: "Finding clothes that align with my personal style used to be a challenge until I discovered Shop.co. The range of options they offer is truly remarkable, catering to a variety of tastes and occasions.",
      MainDivW: "400px",
      MainDivH: "240px",
      RevDivW: "336px",
      SmMainW: "358px",
    ...
    {
      CusName: "James L.",
      CusRev: "As someone who's always on the lookout for unique fashion pieces, I'm thrilled to have stumbled upon Shop.co. The selection of clothes is not only diverse but also on-point with the latest trends.",
      MainDivW: "400px",
      MainDivH: "240px",
      RevDivW: "336px",
      SmMainW: "358px",
  ...
  return (
    <div className="bg-[#FFFFFF] ">
      ...
      <div className="w-full flex justify-center lg:h-[58px] lg:mt-[72px] x-sm:mt-[50px] x-sm:h-[38px] sm:mt-[60px] sm:h-[48px]">
        <h1 className="font-[800] lg:h-[58px] lg:text-[48px] lg:leading-[57.6px] x-sm:h-[38px] x-sm:text-[32px] x-sm:leading-[38.4px] sm:h-[48px] sm:text-[40px] sm:leading-[48.4px]">NEW ARRIVALS</h1>
      </div>
      ...
      <div className="w-full flex justify-center lg:h-[58px] lg:mt-[64px] x-sm:mt-[40px] x-sm:h-[38px] sm:mt-[60px] sm:h-[48px]">
        <h1 className="font-[800] lg:h-[58px] lg:text-[48px] lg:leading-[57.6px] x-sm:h-[38px] x-sm:text-[32px] x-sm:leading-[38.4px] sm:h-[48px] sm:text-[40px] sm:leading-[48.4px]">TOP SELLING</h1>
      </div>
      <div className="w-full scrollbar md:mt-[55px] sm:mt-[42px] x-sm:mt-[32px]">
      ...
      <div className="w-full flex justify-center lg:h-[58px] lg:mt-[70px] sm:h-[70px] sm:mt-[50px] x-sm:h-[72px] x-sm:mt-[40px]">
        <h1 className="font-[800] text-[#000000] lg:w-auto  lg:h-[58px] lg:text-[48px] lg:leading-[57.6px] sm:w-auto sm:h-[70px] sm:text-[40px] sm:leading-[44px] sm:text-start x-sm:w-[246px] x-sm:h-[72px] x-sm:text-[32px] x-sm:leading-[36px] x-sm:text-center">BROWSE BY DRESS STYLE</h1>
      </div>
      <div className="flex justify-center flex-wrap lg:gap-[20px] lg:mt-[64px] sm:gap-[16px] sm:mt-[32px] sm:mx-[26px] x-sm:gap-[16px] x-sm:mt-[28px] x-sm:mx-[24px]">
        <Link href="http://localhost:3000/casual" className="lg:w-auto x-sm:w-full sm:w-auto">
        <div className="relative bg-[#FFFFFF] rounded-[20px] overflow-hidden lg:h-[289px] lg:w-[407px] sm:h-[200px] sm:w-[407px] x-sm:h-[190px] x-sm:w-full ">
         ...
         <div className="absolute lg:top-[25px] lg:left-[36px] x-sm:top-[16px] x-sm:left-[24px]">
           <h1 className="text-[#000000] font-[700] lg:text-[36px] x-sm:text-[24px] x-sm:leading-[32.4px]">Casual</h1>
         </div>
        </div>
        </Link>
        ...
        <Image
         ...
         />
         <div className="absolute lg:top-[25px] lg:left-[36px] x-sm:top-[16px] x-sm:left-[24px]">
           <h1 className="text-[#000000] font-[700] lg:text-[36px] x-sm:text-[24px] x-sm:leading-[32.4px]">Formal</h1>
         </div>
        </div>
        <div className="relative bg-[#FFFFFF] rounded-[20px] overflow-hidden lg:h-[289px] lg:w-[684px] sm:h-[200px] sm:w-[250px] x-sm:h-[190px] x-sm:w-full">
        <Image
         ...
         />
         <div className="absolute lg:top-[25px] lg:left-[36px] x-sm:top-[16px] x-sm:left-[24px]">
           <h1 className="text-[#000000] font-[700] lg:text-[36px] x-sm:text-[24px] x-sm:leading-[32.4px]">Party</h1>
         </div>
        </div> 
        <div className="relative bg-[#FFFFFF] rounded-[20px] overflow-hidden lg:h-[289px] lg:w-[407px] sm:h-[200px] sm:w-[407px] x-sm:h-[190px] x-sm:w-full">
        <Image
         ...
         />
         <div className="absolute lg:top-[25px] lg:left-[36px] x-sm:top-[16px] x-sm:left-[24px]">
           <h1 className="text-[#000000] font-[700] lg:text-[36px] x-sm:text-[24px] x-sm:leading-[32.4px]">Gym</h1>
         </div>
        </div>
      </div>
      </div>
    ...
    <div className="flex w-auto justify-between lg:h-[58px] lg:mt-[80px] lg:mx-[13px] sm:h-[40px] sm:mt-[60px] sm:mx-[16px] x-sm:h-[72px] x-sm:mt-[50px] x-sm:mx-[16px] sm:items-center">
           <h1 className="text-[#000000] font-[800] lg:text-[48px] lg:leading-[57.6px] sm:text-[24px] sm:leading-[28px] x-sm:text-[32px] x-sm:leading-[36px]">OUR HAPPY CUSTOMERS</h1>
